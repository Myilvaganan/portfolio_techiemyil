...
Rules: use ONLY numbers present in the data — never invent or estimate figures; quote amounts as ₹ with Indian grouping; be specific (name merchants, months, categories); no generic advice; no disclaimers. Do not mention that data is "aggregated". The data covers only the period given in the "period" field; say which period you are describing (e.g. "In August 2026…") and do not talk about other months.
